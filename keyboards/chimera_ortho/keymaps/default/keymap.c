...
qk_tap_dance_action_t tap_dance_actions[] = {
  ...
  [TD_ESCF13] = ACTION_TAP_DANCE_DOUBLE(KC_ESC, KC_F13),
  [TD_NUMSYM] = ACTION_TAP_DANCE_DOUBLE(TG(_NUMPAD), TG(_SYMBOLS))
...
#define KC_ESCF13 TD(TD_ESCF13)
#define KC_LEVEL TD(TD_NUMSYM)

const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {

  [_QWERTY] = LAYOUT(
  //,-------+-------+-------+-------+-------+-------+-------.     ,-------+-------+-------+-------+-------+-------+-------.
     KC_GRV , KC_Q  , KC_W  , KC_E  , KC_R  , KC_T  ,KC_SCTL,      KC_SCTR, KC_Y  , KC_U  , KC_I  , KC_O  , KC_P  ,KC_QUOT,
  //|-------+-------+-------+-------+-------+-------+-------|     |-------+-------+-------+-------+-------+-------+-------|
     KC_ESCF13 , KC_A  , KC_S  , KC_D  , KC_F  ,KC_G ,KC_SPLT,      KC_SPRT, KC_H , KC_J  , KC_K  , KC_L  ,KC_SCLN,KC_ENT,
  //|-------+-------+-------+-------+-------+-------+-------|     |-------+-------+-------+-------+-------+-------+-------|
     KC_LSPO, KC_Z  , KC_X  , KC_C  , KC_V  , KC_B , KC_SPFN,      KC_GBRC, KC_N  , KC_M  ,KC_COMM,KC_DOT ,KC_SLSH,KC_RSPC,
  //|-------+-------+-------+-------+-------+-------+-------|     |-------+-------+-------+-------+-------+-------+-------|
                                     KC_MTAB,KC_BSPC,                      KC_SPC ,KC_NMPD
  // \------------------------------+-------+-------+------/       \------+-------+-------+------------------------------/
  ),
  ...
  [_NUMPAD] = LAYOUT(
  //,-------+-------+-------+-------+-------+-------+-------.     ,-------+-------+-------+-------+-------+-------+-------.
     _______,KC_EXLM, KC_AT ,KC_HASH,KC_DLR ,KC_PERC,_______,      _______, KC_EQL, KC_7  , KC_8  , KC_9  ,KC_ASTR,KC_MINS,
  //|-------+-------+-------+-------+-------+-------+-------|     |-------+-------+-------+-------+-------+-------+-------|
     _______,KC_CIRC,KC_AMPR,KC_ASTR,KC_COMM,KC_DOT ,_______,      _______,KC_TILD, KC_4  , KC_5  , KC_6  ,KC_PLUS,_______,
  //|-------+-------+-------+-------+-------+-------+-------|     |-------+-------+-------+-------+-------+-------+-------|
     _______,_______,_______,_______,_______,_______,_______,      _______, KC_0  , KC_1  , KC_2  , KC_3  ,KC_SLSH,_______,
  //|-------+-------+-------+-------+-------+-------+-------|     |-------+-------+-------+-------+-------+-------+-------|
                                     _______,_______,                      _______,_______
  // \------------------------------+-------+-------+------/       \------+-------+-------+------------------------------/
  ),
